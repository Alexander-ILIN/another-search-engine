...
1.  создать папку, в которую будут склонированы исходники и выполнить команду:  
        ...
        git clone https://github.com/Alexander-ILIN/another-search-engine

2.  открыть проект `File --> Open ...`  

3.  добавить папку `\libs` как библиотеку `File --> Project Structure... --> Libraries`  

4.  запустить команду `package` у корневого Maven-проекта `AnotherSearchEngine`, либо в командной строке в корне проекта выполнить команду:  

        mvn package  

5.  убедиться, что сборка прошла успешно:  
