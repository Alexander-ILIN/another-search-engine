...
var API = function(){
    ...
    var send = {
        startIndexing:{
            address: contextPath + '/startIndexing',
            type: 'GET',
        ...
        stopIndexing: {
            address: contextPath + '/stopIndexing',
            type: 'GET',
            action: function(result, $this){
                if (result.result){
                    if ($this.next('.API-error').length) {
        ...
        statistics: {
            address: contextPath + '/statistics',
            type: 'get',
            action: function(result, $this){
                if (result.result){
                    if ($this.next('.API-error').length) {
