...
class SearchIndexNonStandardRepositoryImpl implements SearchIndexNonStandardRepository
{
    ...
    public void saveIndexes(Map<String, Integer> lemmasMap, Map <String, Float> rankedPageLemmasMap, Integer pageId)
    {
        ...
        String qryPrefixInsert = "INSERT INTO " + tablesPrefix + "index (page_id, lemma_id, lemma_rank) VALUES (";
        ...
        for(String currentLemmaStr : rankedPageLemmasMap.keySet())
        {
            ...
            Float currentLemmaRank = rankedPageLemmasMap.get(currentLemmaStr);
